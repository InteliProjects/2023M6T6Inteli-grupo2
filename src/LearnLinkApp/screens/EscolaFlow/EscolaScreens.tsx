...
import PedidosEscola from "./PedidosEscola";
import HistoricoEscola from "./HistoricoEscola";
import PerfilEscola from "./PerfilEscola";
  ...
  // Function to get the text style based on the button state
    ...
    return (
        <View style={[styles.telatemplate, styles.scrollviewFlexBox]}>
            <Navbar />
            {activeButton === 'Pedidos' ? <PedidosEscola /> : activeButton === 'Historico' ? <HistoricoEscola /> : activeButton === 'Perfil' ? <PerfilEscola/> : <PedidosEscola />}
