...
const HistoricoTransportadora = memo(() => {
    return (
        <ScrollView
        ...
        >
            <MainTitle title="Historico" count="4"/>
            <MainFiltros />
            <View style={styles.orderslist}>
                <OrderEntregueFaltaAvaliar path='PedidosFaltaAvaliarE'/>
                <OrderEntregueAvaliado path='PedidosAvaliadoE'/>
                <OrderEntregueFaltaAvaliar path='PedidosFaltaAvaliarE'/>
                <OrderEntregueFaltaAvaliar path='PedidosFaltaAvaliarE'/>
            </View>
        </ScrollView>
...
export default HistoricoTransportadora;
