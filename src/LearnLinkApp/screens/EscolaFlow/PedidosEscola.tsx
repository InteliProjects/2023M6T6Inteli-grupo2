...
const PedidosTransportadora = memo(() => {
  return (
      <ScrollView
      ...
      >
        <MainTitle title="Pedidos" count="6"/>
        <MainFiltros />
        <View style={styles.orderslist}>
          <OrderSeparado path='PedidosSeparadoE'/>
          <OrderCriado path='PedidosConfirmadoE'/>
          <OrderDespachado path='PedidosDespachadoE'/>
          <OrderDespachado path='PedidosDespachadoE'/>
          <OrderSeparado path='PedidosSeparadoE'/>
          <OrderCriado path='PedidosConfirmadoE'/>
          <OrderSeparado path='PedidosSeparadoE'/>
...
export default PedidosTransportadora;
