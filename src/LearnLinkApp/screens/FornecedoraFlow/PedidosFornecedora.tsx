...
const PedidosFornecedora = memo(() => {
  return (
      ...
      >
        <MainTitle title="Pedidos em andamento" count="4"/>
        <MainFiltros />
        <View style={styles.orderslist}>
          <OrderSeparado path='PedidosSeparadoF'/>
          <OrderDespachado path='PedidosDespachadoF'/>
          <OrderDespachado path='PedidosDespachadoF'/>
          <OrderSeparado path='PedidosSeparadoF'/>
        </View>
      </ScrollView>
...
export default PedidosFornecedora;
