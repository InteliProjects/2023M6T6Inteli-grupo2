...
import HomeSeduc from "./HomeSeduc";
import PedidosSeduc from "./PedidosSeduc";
import HistoricoSeduc from "./HistoricoSeduc";
import CriarSeduc from "./CriarSeduc";
import PerfilSeduc from "./PerfilSeduc";
  ...
  // Function to get the text style based on the button state
    ...
    return (
        <View style={[styles.telatemplate, styles.scrollviewFlexBox]}>
            <Navbar />
            {activeButton === 'Home' ? <HomeSeduc /> : activeButton === 'Pedidos' ? <PedidosSeduc /> : activeButton === 'Criar' ? <CriarSeduc /> : activeButton === 'Historico' ? <HistoricoSeduc /> : activeButton === 'Perfil' ? <PerfilSeduc /> : <HomeSeduc />}
            <View style={styles.toolbar}>
                <View style={styles.toolbarItems}>
                    ...
                    <TouchableOpacity 
                        onPress={() => {handleButtonPress('Criar')}}
                    >
                        <Image
