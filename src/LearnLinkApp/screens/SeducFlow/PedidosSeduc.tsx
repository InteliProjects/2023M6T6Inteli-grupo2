...
const PedidosSeduc = memo(() => {
  return (
      ...
      >
        <MainTitle title="Pedidos" />
        <MainFiltros />
        <View style={styles.orderslist}>
          <OrderCriado path='PedidosConfirmadoS'/>
          <OrderSeparado path='PedidosSeparadoS' />
          <OrderDespachado path='PedidosDespachadoS'/>
          <OrderCriado path='PedidosConfirmadoS'/>
          <OrderSeparado path='PedidosSeparadoS'/>
          <OrderDespachado path='PedidosDespachadoS'/>
        </View>
