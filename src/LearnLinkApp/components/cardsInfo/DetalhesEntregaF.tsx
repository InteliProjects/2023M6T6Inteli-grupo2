...
const DetalhesEntregaF = memo(() => {
  return (
    <View style={styles.detalhesEntregaF}>
      <Text style={styles.detalhesDaEntrega}>Detalhes da Entrega</Text>
      <View style={styles.frameParent}>
        <View style={styles.fornecedorParent}>
          <Text style={[styles.fornecedor, styles.contatoTypo]}>
            Fornecedor
          </Text>
          <Text style={[styles.nomeDoFornecedor, styles.textTypo]}>
            Nome do fornecedor
          </Text>
        </View>
...
export default DetalhesEntregaF;
