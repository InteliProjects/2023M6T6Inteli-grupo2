    ...
    <View style={styles.statusconfirmado}>
      ...
      <View style={[styles.statusParent, styles.statusParentSpaceBlock]}>
        <View style={styles.status}>
          ...
          <Text style={styles.confirmado}>Entregue</Text>
        </View>
        <View style={styles.sb5}>
          <View style={[styles.frameParent, styles.framePosition]}>
            ...
            <View style={styles.rec1Parent}>
              <View style={[styles.rec2, styles.recPositionGreen]} />
              <Image
                style={[styles.frameChild, styles.framePosition]}
                resizeMode="cover"
                source={require("../../assets/ellipse-2.png")}
              />
              <Text style={[styles.separado, styles.pastStatus]}>
                Separado
              </Text>
            </View>

            <View style={styles.rec1Parent}>
              <View style={[styles.rec3, styles.recPositionGreen]} />
              <Image
                style={[styles.frameChild, styles.framePosition]}
                resizeMode="cover"
                source={require("../../assets/ellipse-2.png")}
              />
              <Text style={[styles.despachado, styles.pastStatus]}>
                Despachado
              </Text>
            </View>
