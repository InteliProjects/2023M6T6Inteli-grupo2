    ...
    <View style={styles.statusconfirmado}>
      ...
      <View style={[styles.statusParent, styles.statusParentSpaceBlock]}>
        <View style={styles.status}>
          ...
          <Text style={styles.confirmado}>Despachado</Text>
        </View>
          ...
          <View style={[styles.frameParent, styles.framePosition]}>
            ...
            <View style={styles.rec1Parent}>
              ...
              <Image
                ...
                source={require("../../assets/ellipse-2.png")}
              />
              <Text style={[styles.despachado, styles.presentStatus]}>
                Despachado
              </Text>
            </View>
...
export default StatusDespachado;
