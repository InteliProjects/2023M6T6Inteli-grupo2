        ...
        <View style={styles.sb5}>
          <View style={[styles.frameParent, styles.framePosition]}>
            ...
            <View style={styles.rec1Parent}>
              <View style={[styles.rec1, styles.recPosition]} />
              <Image
                style={[styles.frameChild, styles.framePosition]}
                resizeMode="cover"
                source={require("../../assets/ellipse-2.png")}
              />
              <Text style={styles.confirmado1}>Confirmado</Text>
            </View>
            ...
            <View style={styles.rec1Parent}>
              ...
              />
              <Text style={[styles.separado, styles.separadoTypo]}>
                Separado
              </Text>
            </View>
            ...
            <View style={styles.rec1Parent}>
              ...
              />
              <Text style={[styles.despachado, styles.separadoTypo]}>
                Despachado
              </Text>
            </View>
            <View style={styles.rec1Parent}>
...
export default StatusConfirmado;
