...
const OrderEntregueFaltaAvaliar = memo(({path}: {path: string}) => {
  const navigation = useNavigation();
  const telapath = path;

  return (
    <TouchableOpacity style={styles.orderEntregueFaltaAvaliar} onPress={() => navigation.navigate(telapath as never)}>
      <Image
      ...
      <View style={styles.info}>
        ...
        <View style={[styles.parent, styles.wrapperPosition]}>
          <Text style={[styles.text, styles.textClr]}>#00005</Text>
...
export default OrderEntregueFaltaAvaliar;
