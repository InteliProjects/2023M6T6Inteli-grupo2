...
const OrderCriado = memo(({path}: {path: string}) => {
  const navigation = useNavigation();
  const telapath = path;

  return (
    <TouchableOpacity style={styles.orderCriado} onPress={() => navigation.navigate(telapath as never)}>
      <Image
      ...
      <View style={styles.info}>
        ...
        <View style={[styles.emitidoEm25102023Parent, styles.wrapperPosition]}>
          ...
          <Text style={[styles.text, styles.textPosition]}>#00001</Text>
          <Image
