...
const OrderSeparado = memo(({path}: {path: string}) => {
  const navigation = useNavigation();
  const telapath = path;
  

  return (
    <TouchableOpacity style={styles.orderSeparado} onPress={() => navigation.navigate(telapath as never)}>
      <Image
      ...
      <View style={styles.info}>
        <View style={[styles.statusEmPreparaoWrapper, styles.wrapperPosition]}>
          <Text style={[styles.statusEmPreparaoContainer, styles.textPosition]}>
            ...
            <Text style={styles.separado}>Separado</Text>
          </Text>
        </View>
        <View
          style={[
        ...
        <View style={[styles.emitidoEm25102023Parent, styles.wrapperPosition]}>
          ...
          <Text style={[styles.text, styles.textPosition]}>#00002</Text>
          <Image
